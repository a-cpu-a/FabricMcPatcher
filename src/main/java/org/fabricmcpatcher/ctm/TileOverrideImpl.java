...
class TileOverrideImpl {
    final static class CTM extends TileOverride {
        ...
        @Override
        Sprite getTileWorld_Impl(RenderBlockState renderBlockState, Sprite origIcon) {
            int neighborBits = 0;
        ...
        @Override
        Sprite getTileHeld_Impl(RenderBlockState renderBlockState, Sprite origIcon) {
            return icons[0];
        }
    }
    ...
    final static class HorizontalVertical extends Horizontal {
        ...
        @Override
        Sprite getTileWorld_Impl(RenderBlockState renderBlockState, Sprite origIcon) {
            Sprite icon = super.getTileWorld_Impl(renderBlockState, origIcon);
            if (icon != icons[3]) {
                return icon;
            }
            int neighborBits = 0;
