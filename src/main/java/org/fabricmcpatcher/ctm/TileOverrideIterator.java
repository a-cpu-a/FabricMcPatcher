...
abstract public class TileOverrideIterator implements Iterator<ITileOverride> {
    ...
    public ITileOverride go(RenderBlockState renderBlockState, Sprite origIcon) {
        ...
        for (int pass = 0; pass < MAX_RECURSION; pass++) {
            while (hasNext()) {
                ...
                Sprite newIcon = getTile(override, renderBlockState, origIcon);
                if (newIcon != null) {
    ...
    abstract protected Sprite getTile(ITileOverride override, RenderBlockState renderBlockState, Sprite origIcon);
    ...
    public static final class IJK extends TileOverrideIterator {
        ...
        @Override
        protected Sprite getTile(ITileOverride override, RenderBlockState renderBlockState, Sprite origIcon) {
