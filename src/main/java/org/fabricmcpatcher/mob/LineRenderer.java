...
public class LineRenderer {
    ...
    private LineRenderer(String name, double width, double a, double b, int segments) {
        texture = TexturePackAPI.newMCPatcherIdentifier("/misc/" + name + ".png", "line/" + name + ".png");
        active = TexturePackAPI.hasResource(texture);
        //PropertiesFile properties = PropertiesFile.getNonNull(logger, TexturePackAPI.transformIdentifier(texture, ".png", ".properties"));
        PropertiesFile properties = PropertiesFile.getNonNull(logger, "line/" + name + ".properties");
    ...
    private boolean render(double x, double y, double z, double dx, double dy, double dz) {
        ...
        GLAPI.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);*/ //TODO
        dx += sx + plusSX;
        dy += sy + plusSY;
        dz += sz + plusSZ;
        double x0 = x;
...
*/ //TODO
        ...
        //TessellatorAPI.draw(tessellator); //TODO
